...
int solveTab(vector<int> &prices, int n, int k)                 // BOTTOM UP APPROACH (Tabultaion)
{
...
int solveOpti(vector<int> &prices, int n, int k)                       // OPTIMIZED APPROACH
{
...
int main()
{
    ...
    cout<<solveMem(0, 1, k, prices, n, dp)<<endl;
    cout<<solveTab(prices, n, k)<<endl;
    cout<<solveOpti(prices, n, k);
}